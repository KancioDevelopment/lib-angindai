...
func (session *SessionMQ) handleReconnect(addr string) {
	for {
...
func (session *SessionMQ) connect(addr string) (*amqp.Connection, error) {
...
func (session *SessionMQ) handleReInit(conn *amqp.Connection) bool {
	for {
		session.isReady = false
...
func (session *SessionMQ) init(conn *amqp.Connection) error {
	ch, err := conn.Channel()
...
func (session *SessionMQ) changeConnection(connection *amqp.Connection) {
...
func (session *SessionMQ) changeChannel(channel *amqp.Channel) {
